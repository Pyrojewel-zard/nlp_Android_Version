...
public class ExampleUnitTest {
    ...
    public void testTimeNLP() throws URISyntaxException {
        ...
        String a="Hi，all.下周一下午三点开会";
        a=stringPreHandlingModule.numberTranslator(a);
        System.out.println(a.replace(unit[0].Time_Expression,""));
...
//        System.out.println("用时"+(end-timeStart)+"ms");
